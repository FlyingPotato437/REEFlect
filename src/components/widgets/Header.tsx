    ...
    >
      <div className="mx-auto w-full max-w-7xl md:flex md:justify-between md:py-3.5 md:px-4">
        ...
        <div
          ...
          } fixed bottom-0 left-0 w-full justify-end p-3 md:static md:mb-0 md:flex md:w-auto md:self-center md:p-0 bg-white dark:bg-slate-900 border-t border-gray-200 dark:border-slate-600 md:bg-transparent md:dark:bg-transparent md:border-none`}
        >
